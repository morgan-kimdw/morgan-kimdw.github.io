export const company = {
  ...
  executionRule:
    '선택한 Signal을 오늘 실행할 수 있는 작은 단위로 만들고 바로 실행합니다. 결과를 배우는 순간 1원칙 사고가 판단 기준으로 작동하며, 그 배움으로 다음 Signal과 실행을 고릅니다.',
  ...
  principles: [
    ...
    },
    {
      ...
      title: '작게 실행하고 배웁니다',
      description:
        '선택한 Signal을 오늘 실행할 작은 단위로 만들고 바로 움직입니다. 결과를 배우는 순간 1원칙 사고로 의미를 해석하고 다음 실행을 고릅니다.',
    },
  ],
  series: [
    {
